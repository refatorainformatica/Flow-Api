...
namespace Services.Features.Financials.PaymentStates.Exceptions
{
    public static class PaymentStateErrors
    {
        public static Error IsEmpty() =>
            new(
                ErrorType.NoContent,
                ErrorType.NoContent.ToString(),
                "The payment state data was empty"
            );
        ...
        public static Error NotFound(int id) =>
            new(
                ...
                $"The payment state with Id '{id}' was not found"
            );
        ...
        public static Error NotFound(string searchText) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The payment state with term '{searchText}' was not found"
            );
