...
namespace Services.Features.Financials.Revenues.Exceptions
{
    public static class RevenueErrors
    {
        public static Error IsEmpty() =>
            new(ErrorType.NoContent, ErrorType.NoContent.ToString(), "The revenue data was empty");

        public static Error NotFound(int id) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The revenue with Id '{id}' was not found"
            );
        ...
        public static Error NotFound(string searchText) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The revenue with term '{searchText}' was not found"
            );
