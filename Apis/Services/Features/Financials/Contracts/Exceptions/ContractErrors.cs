...
namespace Services.Features.Financials.Contracts.Exceptions
{
    public static class ContractErrors
    {
        public static Error IsEmpty() =>
            new(ErrorType.NoContent, ErrorType.NoContent.ToString(), "The contract data was empty");

        public static Error NotFound(int id) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The contract with Id '{id}' was not found"
            );
        ...
        public static Error NotFound(string searchText) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The contract with term '{searchText}' was not found"
            );
