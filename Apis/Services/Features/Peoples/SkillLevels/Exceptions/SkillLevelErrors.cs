...
namespace Services.Features.Peoples.SkillLevels.Exceptions
{
    public static class SkillLevelErrors
    {
        public static Error IsEmpty() =>
            new(
                ErrorType.NoContent,
                ErrorType.NoContent.ToString(),
                "The skill level data was empty"
            );
        ...
        public static Error NotFound(int id) =>
            new(
                ...
                $"The skill level with Id '{id}' was not found"
            );
        ...
        public static Error NotFound(string searchText) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The skill level with term '{searchText}' was not found"
            );
