...
namespace Services.Features.Peoples.SkillTypes.Exceptions
{
    public static class SkillTypeErrors
    {
        public static Error IsEmpty() =>
            new(
                ErrorType.NoContent,
                ErrorType.NoContent.ToString(),
                "The skill type data was empty"
            );
        ...
        public static Error NotFound(int id) =>
            new(
                ...
                $"The skill type with Id '{id}' was not found"
            );
        ...
        public static Error NotFound(string searchText) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The skill type with term '{searchText}' was not found"
            );
