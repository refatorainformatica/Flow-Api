...
namespace Services.Features.Peoples.Customers.Exceptions
{
    public static class CustomerErrors
    {
        public static Error IsEmpty() =>
            new(ErrorType.NoContent, ErrorType.NoContent.ToString(), "The customer data was empty");
        ...
        public static Error NotFound(string searchText) =>
            new(
                ErrorType.NotFound,
                ErrorType.NotFound.ToString(),
                $"The customer with term '{searchText}' was not found"
            );
